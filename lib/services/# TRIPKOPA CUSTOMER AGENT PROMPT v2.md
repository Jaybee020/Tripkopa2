...
Use `monthly` for calendar-month repayments. If the financing profile confirms post-travel eligibility and the customer requests it, add `post_travel` inside `repayment_plan_request`:
